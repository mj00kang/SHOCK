...
export const INITIAL_NOTICES: Notice[] = [
  {
    id: 'notice-1',
    title: '💎 소장인의 가치 경매 플랫폼 ‘샥(SHOCK)’ 정식 서비스 오픈 안내',
    createdAt: '2026-06-10',
    content: '우리의 마음을 흔들고 인생의 한 자락을 영예롭게 장식해 준 귀중한 취향 애장품 및 수집 희소품들을 더욱 안심하고 깔끔하게 순수 C2C 경매 방식으로 거래할 수 있는 컬렉터스 아레나 샥(SHOCK)에 오신 것을 무궁히 감사드립니다. 유동수수료 0% 보급으로 투명하고 기분 좋은 상향식 흥정 거래의 명소를 체험해보세요.'
  },
  {
    id: 'notice-2',
    title: '🎁 럭키샥 100원 래플 이벤트 추첨 시스템 난수 알고리즘 안내',
    createdAt: '2026-06-10',
    content: '샥의 공식 명예 이벤트인 럭키샥 100원 응모 찬스는 마감 시점에 관리자 및 고객 직접 시연 난수 분산 피커 엔진을 거쳐 100% 기계 편향 없는 정정당당한 중립 추첨을 거쳐 행운 당첨자를 지정합니다. 당첨된 유저는 100원의 상징적 샥머니 코인을 소모하여 우편 무료 배송으로 완벽 수령이 가능합니다.'
  },
  {
    id: 'notice-3',
    title: '🚨 공정한 레이스 보장을 위한 ‘종료 5분전 자동 5분 시간 지연 보강 시스템’ 활성화',
    createdAt: '2026-06-09',
    content: '모든 실시간 상향식 경매에서 마감 시간 5분 안으로 최고가를 뒤엎는 과도하게 공격적인 스나이핑 입찰이 발생할 시, 다른 진정 수집가분들의 반격 방어 기회와 합당한 가치 성립 기회를 지키기 위해 자동으로 잔여 종료 시각이 원격 5분씩 자동 증설 연장되는 연장 가동 룰이 철저하게 실현됩니다.'
  }
];
